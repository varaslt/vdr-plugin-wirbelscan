...
OBJS = $(PLUGIN).o common.o frequencies.o menusetup.o satellites.o scanner.o dvb_wrapper.o scanfilter.o caDescriptor.o statemachine.o
OBJS += countries.o ext_math.o ttext.o
